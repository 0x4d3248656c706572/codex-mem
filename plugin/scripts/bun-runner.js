...
// Self-resolve plugin root when CLAUDE_PLUGIN_ROOT is not set by Codex.
...
// EINVAL when the pipe comes from Codex's hook system. By reading stdin
...
// always receives valid JSON input even when Codex doesn't pipe stdin
